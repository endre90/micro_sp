            ...
            for wp2 in waypoints {
                if wp1 != wp2 {
                    navigate_transitions.push(
                        ParamTransition::new(
                            &format!("navigate_{}_from_{}_to_{}", rover, wp1, wp2),
                            &ppred!(
                                &pass!(&new_bool_assign_c!(&format!("{}_can_traverse_from_{}_to_{}", rover, wp1, wp2), true, "a")),
                                &pass!(&new_bool_assign_c!(&format!("{}_available", rover), true, "b")),
