...
//     let act_pos_dummy = Predicate::ASS(EnumValue::new(&act_pos, "dummy_value", None));
//     let act_stat_dummy = Predicate::ASS(EnumValue::new(&act_pos, "dummy_value", None));
...
//     let act_left = Predicate::ASS(EnumValue::new(&act_pos, "left", None));
//     let not_act_left = Predicate::NOT(Box::new(act_left.clone()));
//     let act_right = Predicate::ASS(EnumValue::new(&act_pos, "right", None));
//     let not_act_right = Predicate::NOT(Box::new(act_right.clone()));

//     let act_idle = Predicate::ASS(EnumValue::new(&act_stat, "idle", None));
//     let not_act_idle = Predicate::NOT(Box::new(act_idle.clone()));
//     let act_active = Predicate::ASS(EnumValue::new(&act_stat, "active", None));
//     let not_act_active = Predicate::NOT(Box::new(act_active.clone()));

//     let ref_left = Predicate::ASS(EnumValue::new(&ref_pos, "left", None));
//     let not_ref_left = Predicate::NOT(Box::new(ref_left.clone()));
//     let ref_right = Predicate::ASS(EnumValue::new(&ref_pos, "right", None));
//     let not_ref_right = Predicate::NOT(Box::new(ref_right.clone()));

//     let ref_idle = Predicate::ASS(EnumValue::new(&ref_stat, "idle", None));
//     let not_ref_idle = Predicate::NOT(Box::new(ref_idle.clone()));
//     let ref_active = Predicate::ASS(EnumValue::new(&ref_stat, "active", None));
//     let not_ref_active = Predicate::NOT(Box::new(ref_active.clone()));
