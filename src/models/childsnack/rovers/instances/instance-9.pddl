...
:init at_lander general waypoint4
...
:init can_traverse rover0 waypoint5 waypoint2
:init can_traverse rover0 waypoint2 waypoint5
...
:init can_traverse rover3 waypoint0 waypoint5
:init can_traverse rover3 waypoint5 waypoint0
...
:init on_board camera4 rover1
:init calibration_target camera4 objective1
