...
:objects waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 waypoint6 - Waypoint
:objects camera0 camera1 camera2 camera3 camera4 camera5 - Camera
...
:init can_traverse rover0 waypoint4 waypoint3
:init can_traverse rover0 waypoint3 waypoint4
:init can_traverse rover0 waypoint4 waypoint6
:init can_traverse rover0 waypoint6 waypoint4
...
:init can_traverse rover2 waypoint3 waypoint4
:init can_traverse rover2 waypoint4 waypoint3
...
:init can_traverse rover3 waypoint0 waypoint2
:init can_traverse rover3 waypoint2 waypoint0
...
:init can_traverse rover3 waypoint6 waypoint5
:init can_traverse rover3 waypoint5 waypoint6
...
:init calibration_target camera3 objective2
:init supports camera3 high_res
:init supports camera3 low_res
:init on_board camera4 rover2
:init calibration_target camera4 objective0
:init supports camera4 colour
:init on_board camera5 rover3
:init calibration_target camera5 objective0
:init supports camera5 colour
:init supports camera5 high_res
