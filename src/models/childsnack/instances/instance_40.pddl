:objects child1 child2 child3 child4 child5 child6 child7 child8 - child
:objects bread1 bread2 bread3 bread4 bread5 bread6 bread7 bread8 - bread-portion
:objects content1 content2 content3 content4 content5 content6 content7 content8 - content-portion
:objects tray1 tray2 tray3 tray4 - tray
:objects table1 table2 table3 table4 kitchen - place
:objects sandwich1 sandwich2 sandwich3 sandwich4 sandwich5 sandwich6 sandwich7 sandwich8 - sandwich

:init at tray1 kitchen
:init at tray2 kitchen
:init at tray3 kitchen
:init at tray4 kitchen
...
:init no_gluten_bread bread7
:init no_gluten_content content7
...
:init waiting child7 table4
:init waiting child8 table4
...
:init notexist sandwich7
:init notexist sandwich8
