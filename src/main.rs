        ...
        false => {
            ...
            for v in cmd_var_vals.clone() {
                let publisher = node
                    ...
                    .expect(
                        "Error f93c6d99-5725-467a-8a96-e49f72b3485f: Creating publishers failed.",
                    );
            ...
            let state_publisher = node
                ...
                .expect(
                    "Error f93c6d99-5725-467a-8a96-e49f72b3485f: Creating state publisher failed.",
                );
            let (tx, rx) = channel::<String>(10);
